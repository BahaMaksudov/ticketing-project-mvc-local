...
public class DataGenerator implements CommandLineRunner {
    ...
    //springboot manages beans for us. we need to create a HAS A Relationship
    //you need to write a constructor
    //always use abstract level - Interface
    //add Interface and add a constructor
    //@Component will create Beans for us - POJO
